...
export function LevelMap({ modules, userStats }: LevelMapProps) {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full overflow-hidden rounded-3xl bg-gradient-to-b from-card to-card/80 p-4 sm:p-6 lg:p-8 border-3 border-primary"
    >
      ...
      <div className="relative mx-auto w-full max-w-4xl">
        ...
        >
          ...
          <g onClick={() => setActiveModule(999)} className="cursor-pointer">
            <g transform="translate(820, 180)">
              ...
              <circle
                ...
                cy="10"
                r="2"
                className="fill-blue-400 stroke-blue-600 stroke-1"
              />
              <circle
                cx="0"
                cy="12"
                ...
                >
                  ...
                  <div className="px-6 pt-6 pb-4">
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed">
                      Master all your skills in this ultimate test. Defeat the
                      boss to prove you're a true Jamaican Sign Language expert!
                    </p>
                  </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${
                              (module.completedLessons / module.lessons) * 100
                            }%`,
                          }}
                        />
                      </div>
